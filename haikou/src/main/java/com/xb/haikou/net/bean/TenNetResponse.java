package com.xb.haikou.net.bean;
...
public class TenNetResponse {
    ...
    public static class DataBean {
        ...
        private List<TencentMacKeyEntity> keys;
        private int curVersion;
        private List<AliPublicKeyEntity> masterKeys;
        private String key;
        ...
        public List<TencentMacKeyEntity> getKeys() {
            return keys;
        }

        public void setKeys(List<TencentMacKeyEntity> keys) {
            this.keys = keys;
        }
        ...
        public List<AliPublicKeyEntity> getMasterKeys() {
            return masterKeys;
        }

        public void setMasterKeys(List<AliPublicKeyEntity> masterKeys) {
