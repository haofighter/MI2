...
public class UnionPayEntity {
    ...
    public UnionPayEntity(Long id, String mchId, String unionPosSn, String posSn,
            ...
            String reserve_4, String tranType, String reserve, String biztype,
            String acquirer, String conductorid, String currency, String transdata,
            Long creattime) {
        this.id = id;
        this.mchId = mchId;
        this.unionPosSn = unionPosSn;
