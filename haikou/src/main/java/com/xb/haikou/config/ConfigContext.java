...
public class ConfigContext {
    ...
    public static String KEY_BUTTON_TOP_LEFT = "topleft";
    public static String KEY_BUTTON_TOP_RIGHT = "topright";
    public static String KEY_BUTTON_BOTTOM_LEFT = "bottomleft";
    public static String KEY_BUTTON_BOTTOM_RIGHT = "bottomright";
}
