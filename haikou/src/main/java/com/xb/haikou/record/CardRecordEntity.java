...
public class CardRecordEntity {
    ...
    @Generated(hash = 283720356)
    public CardRecordEntity(Long id, String bizType, String status, String cardType,
            String tradeType, String psamTradeCount, String cardNo, String cardAmt,
            int fareAmt, String tradeTime, String cardTradeCount, String tACCode,
            String companyNo, String lineNo, String busNo, String driverNo,
            String pasmNumber, String direction, String currenStation,
            String ticketMore, String currentLineNo, String currentBusNo,
            String currentDriverNo, String backup, String termid, String termseq,
            String mchid, String keytype, String citycode, String internalcode,
            String keyver, String keyindex, String cardissuercitycode,
            String cardmaintype, String lasttranstype, String lastterminalid,
            String lasttranstime, String lastpayfee, String lastcardtransseqid,
            String cardversion, String acquirer, String cardIssuerId,
            String transStatus, String totalFee, String currency, String uid,
            String isUploade, Long time, String mrchid, String applytype,
            String conductorId, String transKeyVersion, String cardVersion,
            String transSeqId, String cardissuercitycode2, String algTag,
            String batchNo, String cardCsn, String psamTerminalId) {
        this.id = id;
