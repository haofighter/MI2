...
public class LoadingDialog {
    ...
    public LoadingDialog(Context context) {
        ...
        View view = View.inflate(context, R.layout.common_loadingdialog, null);
...
//        		imageView.startAnimation(mRotateAnimation);
        AnimationDrawable ad = (AnimationDrawable) context.getResources().getDrawable(R.drawable.anim_loading_progress_round);
        imageView.setBackgroundDrawable(ad);
        ad.start();

        d = new Dialog(context, R.style.dialog);// 加入样式
